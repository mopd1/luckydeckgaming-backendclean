 ...
 */
router.get('/seasons', authenticateAdminToken, async (req, res) => {
  try {
 ...
 */
router.get('/seasons/:seasonId', authenticateAdminToken, async (req, res) => {
  try {
 ...
 * Create a new season
 */
router.post('/seasons', authenticateAdminToken, async (req, res) => {
 ...
 * Update a season
 */
router.put('/seasons/:seasonId', authenticateAdminToken, async (req, res) => {
  try {
    const { 
      name, 
      description, 
 ...
 * Delete a season
 */
router.delete('/seasons/:seasonId', authenticateAdminToken, async (req, res) => {
  const transaction = await sequelize.transaction();
 ...
 */
router.get('/seasons/:seasonId/milestones', authenticateAdminToken, async (req, res) => {
  try {
 ...
 */
router.post('/seasons/:seasonId/milestones', authenticateAdminToken, async (req, res) => {
  const transaction = await sequelize.transaction();
 ...
 */
router.post('/import-sheet', authenticateAdminToken, async (req, res) => {
  const transaction = await sequelize.transaction();
 ...
 */
router.get('/seasons/:seasonId/user-progress', authenticateAdminToken, async (req, res) => {
  try {
 ...
 */
router.get('/seasons/:seasonId/analytics', authenticateAdminToken, async (req, res) => {
  try {
